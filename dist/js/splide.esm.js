...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function child(parent, tagOrClassName) {
          if (parent) {
            return (
              values(parent.children).filter(function (child) {
                return (
                  hasClass(child, tagOrClassName.split(" ")[0]) ||
                  child.tagName.toLowerCase() === tagOrClassName
                );
              })[0] || null
            );
          }
        ...
        /* harmony default export */ var transitions_slide = function (
          Splide,
          Components
        ) {
          /**
        ...
        var splide_Splide = /*#__PURE__*/ (function () {
          ...
          _proto.mount = function mount(Extensions, Transition) {
            ...
            this.Components =
              this.Components ||
              compose(this, merge(this._c, Extensions), Transition);
   ...
   * @return {number} - The current slide index.
   // */
        ...
        /* harmony default export */ var components_options = function (
          Splide
        ) {
          /**
        ...
        /* harmony default export */ var elements_slide = function (
          ...
          var STATUS_UPDATE_EVENTS =
            "ready.slide updated.slide resize.slide " +
          ...
          var Slide = {
            ...
            isVisible: function isVisible() {
              ...
              var prop =
                Splide.options.direction === TTB
                  ? "clientHeight"
                  : "clientWidth";
              var position = floor(
                (Track.toPosition(index) +
                  Track.offset(index) -
                  Track.position) *
                  Track.sign
              );
              ...
              return (
                0 <= position && position <= size && 0 <= edge && edge <= size
              );
            },
        ...
        /* harmony default export */ var controller = function (
          Splide,
          Components
        ) {
          /**
          ...
          var Controller = {
            ...
            parse: function parse(control) {
              ...
              switch (indicator) {
                ...
                case ">":
                  index = this.toIndex(
                    number > -1 ? number : this.toPage(index) + 1
                  );
                  break;
            ...
            toIndex: function toIndex(page) {
              ...
              index =
                ...
                (this.pageLength * perPage - length) *
                  controller_floor(index / length); // Adjustment for the last page.
        ...
        /* harmony default export */ var vertical = function (
          Splide,
          Components
        ) {
          /**
          ...
          return {
            ...
            toPosition: function toPosition(index) {
              return -(
                (index + Components.Clones.length / 2) *
                  (Layout.slideHeight() + Layout.gap) +
                this.offset()
              );
            },
            ...
            toIndex: function toIndex(position) {
              ...
              var cloneOffset =
                ((slideHeight + Layout.gap) * Components.Clones.length) / 2;
              return Math.round(
                -(position + cloneOffset + this.offset()) /
                  (slideHeight + Layout.gap)
              );
            },
        ...
        /* harmony default export */ var horizontal = function (
          Splide,
          Components
        ) {
          /**
          ...
          return {
            ...
            toPosition: function toPosition(index) {
              return (
                this.sign * (Layout.totalWidth(index - 1) + this.offset(index))
              );
            },
            ...
            toIndex: function toIndex(position) {
              ...
              if (Splide.is(SLIDE)) {
                position = between(
                  position,
                  Layout.totalWidth(Elements.total),
                  0
                );
              }
              ...
              for (var i in Slides) {
                ...
                if (
                  ...
                  position <=
                    slidePosition + Layout.slideWidth(slideIndex) + Layout.gap
                ) {
                  return slideIndex;
                }
              }
        ...
        /* harmony default export */ var components_track = function (
          Splide,
          Components
        ) {
          /**
        ...
        /* harmony default export */ var components_clones = function (
          Splide,
          Components
        ) {
          /**
          ...
          function getCloneCount() {
            ...
            return (
              options.perPage * (options.drag ? options.flickMaxPages + 1 : 1)
            );
          }
          /**
        ...
        /* harmony default export */ var directions_horizontal = function (
          Splide,
          Components
        ) {
          /**
            ...
            totalWidth: function totalWidth(index) {
              ...
              return Elements.getSlides(true)
                ...
                .reduce(function (accumulator, Slide) {
                  return (
                    accumulator + _this.slideWidth(Slide.index) + _this.gap
                  );
                }, 0);
            },
        ...
        /* harmony default export */ var directions_vertical = function (
          Splide,
          Components
        ) {
          /**
        ...
        /* harmony default export */ var layout = function (
          Splide,
          Components
        ) {
          /**
          ...
          var Layout = object_assign(
            ...
            Splide.options.direction === TTB
              ? directions_vertical(Splide, Components)
              : directions_horizontal(Splide, Components)
          );
          /**
           * Init slider styles according to options.
           */
          ...
          function resize() {
            ...
            Elements.each(function (Slide) {
              ...
              applyStyle(Slide.slide, {
                width: Splide.options.autoWidth
                  ? null
        ...
        /* harmony default export */ var drag = function (Splide, Components) {
          ...
          var Drag = {
            ...
            mount: function mount() {
              ...
              Splide.on("touchstart mousedown", start, list)
                .on("touchmove mousemove", move, list, {
                  passive: false,
                })
                .on(
          ...
          function shouldMove(_ref) {
            ...
            if (Splide.State.is(IDLE)) {
              var angle =
                (Math.atan(abs(offset.y) / abs(offset.x)) * 180) / Math.PI;
          ...
          function go(info) {
            ...
            if (absV > 0) {
              ...
              if (
                ...
                abs(info.offset[axis]) < options.swipeDistanceThreshold
              ) {
                destination +=
                  sign *
                  Math.min(
                    absV * options.flickPower,
                    Layout.width * (options.flickMaxPages || 1)
                  );
              }
        ...
        /* harmony default export */ var components_autoplay = function (
          Splide,
          Components,
          name
        ) {
        ...
        /* harmony default export */ var components_cover = function (
          Splide,
          Components
        ) {
          /**
        ...
        /* harmony default export */ var components_arrows = function (
          Splide,
          Components,
          name
        ) {
        ...
        /* harmony default export */ var pagination = function (
          ...
          var Pagination = {
            ...
            mount: function mount() {
              ...
              var slider = Elements.slider;
              var parent =
                Splide.options.pagination === "slider" && slider
                  ? slider
                  : Splide.root;
          ...
          function bind() {
            Splide.on(ATTRIBUTES_UPDATE_EVENT, update).on(
              UPDATE_EVENT,
              function () {
                Pagination.destroy();
          ...
          var Lazyload = {
            ...
            mount: function mount() {
              Splide.on("mounted refresh", function () {
                ...
                Components.Elements.each(function (Slide) {
                  each(
                    Slide.slide.querySelectorAll("[" + SRC_DATA_NAME + "]"),
                    function (img) {
                      if (!img.src) {
                        images.push({
                          img: img,
        ...
        /* harmony default export */ var components_breakpoints = function (
          Splide
        ) {
          /**
           * Store breakpoints.
